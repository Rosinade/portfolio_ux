...
.pauseFor(1800)
.changeDelay(20)
.typeString('I\'m Rosanora')
.pauseFor(300)
.typeString('<strong>, UX Designer</strong> !')
.pauseFor(1000)
.deleteChars(13)
.typeString('<span style="color: #ff5a3f;"> UI Designer</span> !')
.pauseFor(1000)
.deleteChars(13)
.typeString('<span style="color: #586871;"> Art Director</span> !')
.pauseFor(1000)
